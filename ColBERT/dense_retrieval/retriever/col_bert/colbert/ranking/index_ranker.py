...
class IndexRanker():
    def __init__(self, tensor, doclens):
        ...
        # self.buffers = self._create_buffers(BSIZE, torch.float16, {'cpu', 'cuda:0'}) 
    ...
    #             outdim = t.size(0) - stride + 1
    #             print(f'dim{outdim}')
    #             view = torch.as_strided(t, (outdim, stride, self.dim), (self.dim, self.dim, 1))
    #             print(view.shape)
    #             views.append(view)
